...
export const CAPABILITY_MANIFEST = [
    {
        ...
        gap: "The website has no first-class structured meal composer.",
        targetPr: "PR 2",
    },
    {
        id: "meal.read",
    ...
    },
    {
        ...
        intentionalChannelException: null,
        gap: "Website shows pending drafts but cannot create or edit them.",
        targetPr: "PR 3",
    },
    {
        id: "mealDraft.read",
        ...
        web: partial(["/api/app/today"]),
        intentionalChannelException: null,
        gap: "Only a summary of open drafts is currently returned to the website.",
        targetPr: "PR 3",
    },
    {
        id: "mealDraft.review",
        ...
        web: missing(),
        intentionalChannelException: null,
        gap: "Draft review and correction controls are not available on the website.",
        targetPr: "PR 3",
    },
    {
        id: "mealDraft.update",
        ...
        web: missing(),
        intentionalChannelException: null,
        gap: "Website users cannot correct quantities, items, or draft questions.",
        targetPr: "PR 3",
    },
    {
        ...
        web: missing(),
        intentionalChannelException: null,
        gap: "Website users cannot explicitly confirm a pending draft.",
        targetPr: "PR 3",
    },
    {
        id: "mealDraft.cancel",
        ...
        web: missing(),
        intentionalChannelException: null,
        gap: "Website users cannot abandon a pending draft.",
        targetPr: "PR 3",
    },
    {
        id: "food.search",
        ...
        web: missing(),
        intentionalChannelException: null,
        gap: "Food search must be integrated into the website meal composer.",
        targetPr: "PR 2",
    },
    {
        id: "food.inspect",
        ...
        web: missing(),
        intentionalChannelException: null,
        gap: "Food details and portions are not selectable from the website.",
        targetPr: "PR 2",
    },
    {
        id: "food.barcode",
        ...
        web: missing(),
        intentionalChannelException: null,
        gap: "The website has no barcode lookup path.",
        targetPr: "PR 2",
    },
    {
        id: "food.saved.read",
        ...
        web: missing(),
        intentionalChannelException: null,
        gap: "Saved foods are not yet available inside a website logging workflow.",
        targetPr: "PR 2",
    },
    {
        id: "food.saved.write",
