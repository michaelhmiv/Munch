...
function serializeMealItem(record: StructuredMealItemRecord) {
    return {
        ...
        gram_weight: record.gramWeight,
        nutrients: {
            calories: nullable(record.nutrients.calories),
            protein_g: nullable(record.nutrients.protein_g),
            carbs_g: nullable(record.nutrients.carbs_g),
            fat_g: nullable(record.nutrients.fat_g),
            fiber_g: nullable(record.nutrients.fiber_g),
            sugar_g: nullable(record.nutrients.sugar_g),
            alcohol_g: nullable(record.nutrients.alcohol_g),
            sodium_mg: nullable(record.nutrients.sodium_mg),
            saturated_fat_g: nullable(record.nutrients.saturated_fat_g),
            cholesterol_mg: nullable(record.nutrients.cholesterol_mg),
            potassium_mg: nullable(record.nutrients.potassium_mg),
        },
        source_type: record.sourceType,
        provider: record.provider,
        provider_food_id: record.providerFoodId,
        provider_revision: record.providerRevision,
