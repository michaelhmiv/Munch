-- Denormalized Pantry planning metadata for fast, deliberate meal recommendations.
-- Pantry inventory remains the source of truth for possession/quantity; this table
-- is a refreshable decision cache for nutrition and culinary-role reasoning.
